...
import com.opnlms.app.OpnlmsApp;
import com.opnlms.app.config.AsyncSyncConfiguration;
import com.opnlms.app.config.EmbeddedSQL;
...
@SpringBootTest(classes = { OpnlmsApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
