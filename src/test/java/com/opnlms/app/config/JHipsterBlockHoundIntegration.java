...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.opnlms.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.opnlms.app.security.DomainUserDetailsService", "createSpringSecurityUser");
